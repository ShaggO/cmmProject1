...
using a simple damping method \todo{Add reference (wiki):
...
(step 3) we use Newton's second law of motion \todo{Add reference,
...
to calculate the time ``integration'' \todo{Add reference,
